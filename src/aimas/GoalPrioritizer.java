...
public class GoalPrioritizer {
    ...
    public static void main(String[] args){
        ...
        Cell startingCell = new Cell(21,30); // << Set starting cell
        Cell finishingCell = new Cell(15,15); // << Set finishing cell
...
//        }
        ...
        HashMap<Cell, ArrayList<ArrayList<ArrayList<Cell>>>> reachabilityMap =
                goalPrioritizer.findLinearizations(level);
...
//        }
    ...
    public HashMap<Cell, ArrayList<ArrayList<ArrayList<Cell>>>> findLinearizations(ArrayList<ArrayList<Cell>> level ) {
            ...
            for (int j = 1; j < goalCells.size(); j++){
               ...
               // curCSizeList.add(new ArrayList<ArrayList<Cell>>(globalCombs));
                ...
                for(int k = 0; k<globalCombs.size(); k++){
                    if (isCombinationBlocking(goalCell,globalCombs.get(k), level)){
    ...
    private boolean isCombinationBlocking(Cell goalCell, ArrayList<Cell> combination,
    ...
    private ArrayList<ArrayList<Cell>> prioritizeGoals( ArrayList<ArrayList<Cell>> level ){
        boolean wObstacles = true; // walls are obstacles
        boolean aObstacles = false; // agents are obstacles
        boolean bObstacles = true;
